...
// })
  ...
  const circle = document.querySelector(".page7 > .circle");

  // Function to scale the circle up
  function scaleUp() {
    gsap.to(circle, { scale: 3, duration: 3, delay:0 });
  }

  // Function to scale the circle back to its original form
  function scaleDown() {
    gsap.to(circle, { scale: 1.5, duration: 1.5, delay:1 });
  }

  // Create a GSAP timeline with the callbacks
